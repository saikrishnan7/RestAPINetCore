...
namespace Library.API.Controllers
{
    ...
    public class BooksController : Controller
    {
        ...
        public IActionResult GetBooksForAuthor(Guid authorId)
        {
            ...
            var booksToReturn = new LinkedCollectionResourceWrapperDto<BookDto>(booksForAuthor);
            return Ok(CreateLinksForBooks(booksToReturn));
        }
        ...
        public IActionResult CreateBookForAuthor(Guid authorId, [FromBody] BookForCreationDto book)
        {
            ...
            return CreatedAtRoute("GetBookForAuthor", 
                new { authorId, id = bookToReturn.Id }, CreateLinksForBook(bookToReturn));
        }
        ...
        public IActionResult DeleteBookForAuthor(Guid authorId, Guid id)
        {
            ...
            if (!_libraryRepository.Save())
            {
                throw new Exception($"Error deleting book with id: {id}");
            }
            ...
            , [FromBody] JsonPatchDocument<BookForUpdateDto> patchDoc)
        {
            ...
            if (bookForAuthorFromRepo == null)
            {
                ...
                {
                    ModelState.AddModelError(nameof(BookForUpdateDto), "Description should be different from Title");
                }
                ...
                if (!_libraryRepository.Save())
                {
                    throw new Exception($"An error occured with patch for id: {id}");
                }
